...
public class SysComEx
{
   ...
   */
  public SysComEx(final List<String> commandInformation)
  {
...
public int executeCommand()
  throws IOException, InterruptedException
  {
    ...
    try
    {
      ...
      String dir = commandInformation.get(2).split("\\s+")[1];
      if(commandInformation.get(2).split("\\s+")[0].equals("cd"))
      {
